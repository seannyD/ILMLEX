...
function hideAllInstructions(){
	...
	// clears cont and info
		for(var i=0;i< 6;++i){
			document.getElementById("cont"+(i+1)).src = "";	
			document.getElementById("cont"+(i+1)).style.display = 'none';
		//	setStim("cont"+(i+1),-1);
			}
			document.getElementById("rightStimTestImage").src = "";	
			document.getElementById("rightStimTestImage").style.display = 'none';
			document.getElementById("leftStimTestImage").src = "";	
			document.getElementById("leftStimTestImage").style.display = 'none';
